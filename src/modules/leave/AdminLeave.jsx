                ...
                {loading ? (
                  ...
                  leaves.map((leave, index) => (
                    ...
                    >
                      ...
                      {/* REASON */}
                      <td className="p-4 text-gray-600 max-w-[220px]">
                        {leave.reason}
                      </td>
                      ...
                      <td className="p-4 min-w-[220px]">
                        ...
                        <textarea
                          ...
                          className="w-full border border-blue-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none p-3 rounded-xl text-sm"
                        />
