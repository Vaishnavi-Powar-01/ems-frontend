...
const Sidebar = () => {
  ...
  return (
    <aside className="w-72 min-w-72 h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white flex flex-col border-r border-gray-700 shadow-xl">
      {" "}
      {/* LOGO */}
